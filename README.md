> **R164 (2026-08-13)**: Public API cleanup + workspace warning zero. MockLlmProvider trait deprecation removed (R163 had 30 actionable warnings, now 0). 7 VCP-named public APIs renamed to legacy (from_vcp -> from_legacy_str/value, as_vcp_str -> as_legacy_str, from_vcp_name -> from_legacy_name, VCP_COMMAND_COUNT -> LEGACY_COMMAND_COUNT). ratatui set_cursor -> set_cursor_position. 15 files touched, 858 tests pass cumulative, 0 touches 3 immutable spines. See `docs/r164/r164-api-cleanup-and-warning-zero.md`.
> 
