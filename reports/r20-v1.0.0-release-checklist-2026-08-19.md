...
| 9 | ci (GitHub Actions green, 5 守门 + 7 matrix) | SKIP | — | — |
| 10 | i18n (中英文档 0 missing, 蓝图 §3.5 P1) | ✅ PASS | — | — |
| 11 | license (Apache 2.0 + NOTICE + 第三方 LICENSE, cargo deny license 0 错) | ❌ FAIL | — | P0 |
| 12 | signature (8 形态签名: deb.gpg / rpm.gpg / brew / scoop / tarball / image.cosign / git.tag.gpg / crates.io.token) | ❌ FAIL | — | P0 |
