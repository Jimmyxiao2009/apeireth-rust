# Next-ROI Targets — V1156+ Roadmap (from v1155-38e84440)
...
|-----:|-----|------:|-------:|---------------:|-----------|
| 1 | `v2_philosophy` | 0.7143 | 0.0500 | **0.0143** | value=0.7143 R 真测, weight=0.0500 高, 潜在涨 0.0143 |
...
- **V1156** = `v2_philosophy` 真补 (potential_gain=0.0143)
