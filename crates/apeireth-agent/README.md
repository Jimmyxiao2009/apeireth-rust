...
> Apeireth R17 鎴樺焦 2-4: Agent 绠＄悊绯荤粺 (alias 瑙ｆ瀽 + LRU cache + notify 鐑姞杞? VCP 鍊熼壌 agentManager.js 339 琛屽瓧娈电骇澶嶅埢)
...
`BORROWED_VCP_FIELDS` -> `BORROWED_LEGACY_FIELDS`. 64 tests pass.
