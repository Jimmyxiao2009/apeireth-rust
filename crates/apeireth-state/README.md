...
> Apeireth R21 鍊熼壌 Golutra #6: 9 Tauri state 妯″紡 (OnceLock + Arc + Mutex) 杞?TUI 绛変环鐗?(ratatui state 鍏变韩妗嗘灦). 3 妯″紡 (OnceLockState / MutexState / RwLockState) + 9 鍣ㄥ畼 state 鍏变韩 (heart/brain/hand/eye/ear/memory/voice/body/mind) + 1 瀹屾暣鐘舵€佸叡浜緥瀛?+ 25+ 闆嗘垚娴嬭瘯. 0 鐪熸帴 tokio/async, 鐣?R21 缁湡鎺? 0 瑙︾ 24 LOCKED crate + 0 鏀?workspace version + 6 鍝插 anchor + 8 椤逛笉淇敼鎵胯
