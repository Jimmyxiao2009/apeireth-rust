...
// ============================================================================
// R150 P1 #12: property_tests module (proptest 借鉴, dev-dep only)
// ============================================================================
#[cfg(test)]
mod property_tests;
...
impl RetryPolicy {
    pub fn new(max_retries: u32, base_delay_ms: u32) -> Self {
        Self {
            max_retries,
            base_delay_ms,
        }
...
mod tests {
    use super::*;
    #[test]
    fn normal_case_validates() {
        assert!(TestCase::new("smoke", "apeireth-api", 3).validate());
    }
    #[test]
    fn excessive_retry_fails() {
        assert!(!TestCase::new("flaky", "x", 20).validate());
    }
    ...
    #[test]
    fn retry_policy_delay_overflow_safe() {
    ...
    #[test]
    fn suite_summary_empty_is_clean() {
        let s = SuiteSummary::new();
        assert!(s.is_clean());
        assert_eq!(s.pass_rate(), 1.0);
    }
    #[test]
    fn summarize_from_tuples() {
        let v = vec![
    ...
    #[test]
    fn retry_count_within_policy_basic() {
