...
#[test]
fn clap_unknown_top_errors() {
    assert!(parse_subcommand_args(&["foo".into()]).is_err());
}
#[test]
fn clap_empty_errors() {
    assert!(parse_subcommand_args(&[]).is_err());
}
#[test]
fn clap_unknown_sub_errors() {
    assert!(parse_subcommand_args(&["skills".into(), "foo".into()]).is_err());
}

// dispatch tests
#[test]
fn dispatch_skills_list_with_data() {
    let dir = make_temp_dir_with_skill();
    let r = dispatch_subcommand(CliSubCommand::Skills(SkillsSubCommand::List {
        dir: dir.clone(),
    }))
    .unwrap();
...
#[test]
fn dispatch_skills_validate_valid_file() {
    let dir = make_temp_dir_with_skill();
    let r = dispatch_subcommand(CliSubCommand::Skills(SkillsSubCommand::Validate {
        file: dir.join("test-skill.json"),
    }))
    .unwrap();
...
#[test]
fn dispatch_skills_validate_invalid_file() {
    assert!(
        dispatch_subcommand(CliSubCommand::Skills(SkillsSubCommand::Validate {
...
#[test]
fn dispatch_skills_scenarios_with_data() {
    let dir = make_temp_dir_with_skill();
    let r = dispatch_subcommand(CliSubCommand::Skills(SkillsSubCommand::Scenarios {
        dir: dir.clone(),
    }))
    .unwrap();
...
#[test]
fn dispatch_skills_watch() {
    let dir = make_temp_dir_with_skill();
    let r = dispatch_subcommand(CliSubCommand::Skills(SkillsSubCommand::Watch {
        dir: dir.clone(),
    }))
    .unwrap();
...
#[test]
fn dispatch_eval_scenarios_delegates() {
    let dir = make_temp_dir_with_skill();
    let r = dispatch_subcommand(CliSubCommand::Eval(EvalSubCommand::Scenarios {
        dir: dir.clone(),
    }))
    .unwrap();
    assert!(r.contains("Eval Scenarios"));
