...
Apeireth 1.0 工作区 crate。src 模块 11 个: council_bridge / critic (R215 TP18 校准诊断) / engine (6 状态机 + fail-6) / fail (trait fail-6) / lib / library_autonomy_loop / library_autonomy / poda_cycle / state / traits / voyager_api (R215 continual learner facade)。测试数(单测标注): 193。
