...
use crate::memory_provider::error::MemoryProviderResult;
use crate::memory_provider::in_memory::InMemoryProvider;
use crate::memory_provider::provider_kind::{ProviderKind, PROVIDER_KIND_VARIANT_COUNT};
use crate::memory_provider::sqlite::SqliteProvider;
...
mod tests {
    ...
    async fn query_no_filter_returns_invalid() {
        ...
        assert!(matches!(
            err,
            crate::memory_provider::error::MemoryProviderError::InvalidQuery(_)
        ));
    }
