...
//!
//! 1:1 翻译 v0.9.21 商业版 `out/main` 集成面 (per blueprint §2.5.3):
...
//! ## v0.9.21 实查
//!
//! 商业版 `out/main/chunks/*` + `out/main/agent/AgentMCPServer.js` 0 处 observability 集成
...
//! 2. `.minimax-agent-cn\spectrai\commercial-nsis\v0901\app-64\app-extracted\out\main\` (v0.9.21 1:1 翻译源, 0 集成实查)
