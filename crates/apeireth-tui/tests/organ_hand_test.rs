...
fn six_tools_hardcoded_and_synced() {
    ...
    assert_eq!(organ::hand::SIX_TOOLS, TOOL_WHITELIST, "hand 6 工具跟 test_common 同步");
    assert_eq!(organ::hand::SIX_TOOLS, error::TOOL_WHITELIST, "hand 6 工具跟 error::TOOL_WHITELIST 同步");
...
fn render_marks_partial_honestly() {
    ...
    assert!(out.contains("[HAND]") || out.contains("手"), "hand render 实际业务字段: {out}");
}
