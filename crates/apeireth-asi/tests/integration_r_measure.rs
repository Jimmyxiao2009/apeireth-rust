//! A8 集成测试：R-Measure（V0.5 24 维 + V1136 9 子测度）实测状态诚实登记
//!
...
//! - `T2` V1136 9 子测度字段存在性（5+2 可见 = 7 维，v4.1 §14 提议 9 子测度差 0 缺口登记）
...
/// T1.1: V0.5 24 维 skeleton 字段全部就位
#[test]
...
// ============================================
// T2: V1136 9 子测度字段存在性（5+2=7 维）
// ============================================

/// T2.1: V1136 9 子测度 skeleton 字段全部就位（5+2）
#[test]
