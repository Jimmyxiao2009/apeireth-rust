...
use crate::mcp::{DailyNoteMcp, McpRequest, McpResponse};
use crate::note::DailyNote;
use crate::store::DailyNoteStore;
use crate::search::search_notes;
use crate::export::{export_markdown, export_json};
...
impl EnhancedDailyNote {
    ...
    pub fn insert(&self, note: &DailyNote) -> Result<(), crate::store::DailyNoteError> {
        self.store.insert(note)
    }
    pub fn search(&self, query: &str, tag: Option<&str>) -> Result<Vec<crate::note::DailyNote>, crate::store::DailyNoteError> {
