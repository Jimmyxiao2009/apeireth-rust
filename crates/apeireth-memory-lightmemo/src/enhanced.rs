...
use crate::manager::{MemoryManager, MemoryItem};
use crate::decay::DecayEngine;
use crate::dream::DreamSubsystem;
use crate::mcp::{LightMemoMcp, McpRequest, McpResponse};
...
impl EnhancedLightMemo {
    pub fn new_in_memory() -> Result<Self, crate::manager::MemoryError> {
        Ok(Self {
    ...
    pub fn add_memory(&mut self, content: &str, tags: Vec<String>) -> Result<String, crate::manager::MemoryError> {
