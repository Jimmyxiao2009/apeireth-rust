...
use crate::l1_file::{L1FileStore, FileEntry};
use crate::l2_vector::{L2VectorStore, VectorEntry};
use crate::l3_tag::TagIndex;
use crate::l4_lcm::L4LcmCompressor;

#[derive(Debug, Error)]
pub enum MemoryError {
    #[error("L1: `{0}`")]
    L1(#[from] crate::l1_file::L1Error),
