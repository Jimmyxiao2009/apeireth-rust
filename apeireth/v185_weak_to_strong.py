...
class V185WeakToStrong:
    ...
    def measure(self, weak_perf, strong_perf):
        self.measurements.append({"weak": weak_perf, "strong": strong_perf})
    ...
    def stats(self):
        return {"n_measurements": len(self.measurements), "version": V185_VERSION,
